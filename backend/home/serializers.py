...
class CourseContentSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ('course_id', 'course_name','course_display_name', 'course_image_url', 'course_description', 'course_skills', 'course_languages', 'course_level', 'course_duration', 'course_about', 'course_outcomes', 'course_organizations', 'course_instructors')
